  ...
  switch (color) {
    case "danger":
      return (
        ...
        bg-red-600 hover:bg-red-700 text-red-50 transition-all flex items-center justify-center ${className}`}
        >
          {children}
        </button>
      );
    case "success":
      return (
        ...
        bg-green-600 hover:bg-green-700 text-green-50 transition-all flex items-center justify-center ${className}`}
        >
          {children}
        </button>
      );
    case "warning":
      return (
        ...
        bg-yellow-600 hover:bg-yellow-700 text-yellow-50 transition-all flex items-center justify-center ${className}`}
        >
          {children}
        </button>
      );
    case "secondary":
      return (
        ...
        bg-zinc-600 hover:bg-zinc-700 text-zinc-50 transition-all flex items-center justify-center ${className}`}
        >
          {children}
        </button>
      );
    default:
      return (
        ...
        bg-blue-600 hover:bg-blue-700 text-blue-50 transition-all flex items-center justify-center ${className}`}
        >
          {children}
        </button>
      );
